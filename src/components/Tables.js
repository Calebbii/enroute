function Tables() {
    ...
    const registered_org = ['Gertrudes','Reale','Mater','Aga Khan','MP Sha','Equity Afia','Rails']
    const first_name = ['Caleb','Kelvin','Ian','Amina','Levi','Breens','Ali']
    const last_name = ['Gertrudes','Reale','Mater','Aga Khan','MP Sha','Equity Afia','Rails']

    const users = [
        { firstName: 'John', lastName: 'Doe', idNumber: '812456156', carRegistration: 'KDE 078T'},
        { firstName: 'Jane', lastName: 'Doe', idNumber: '812456156', carRegistration: 'KDE 078T'},
        { firstName: 'Bob', lastName: 'Smith', idNumber: '812456156', carRegistration: 'KDE 078T'}
      ];
          ...
          <nav class="navbar navbar-top navbar-expand navbar-dashboard navbar-dark ps-0 pe-2 pb-0">
            ...
            <div class="py-4">
                ...
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Active Members section</li>
                </ol>
                </nav>
                ...
                <div>
                    <a href="/addmember" class="btn btn-outline-gray-600 d-inline-flex align-items-center">
