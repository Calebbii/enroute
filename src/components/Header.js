...
function Header() {
    return (
        <div className="header-container">
            ...
            <Link class="navbar-brand me-lg-5" to={{ pathname: "/"}}><img class="navbar-brand-dark" src="assets/img/light.svg" alt="enroute logo" /> <img class="navbar-brand-light" src="assets/img/dark.svg" alt="Rich logo" /></Link>
            ...
            <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
                ...
                <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
                    <div class="d-flex align-items-center">
                        <div class="avatar-lg me-4"><img src="assets/img/profile-picture-3.jpg" class="card-img-top rounded-circle border-white" alt="Caleb Bii"/></div>
                        <div class="d-block">
                            <h2 class="h5 mb-3">Hi, Caleb</h2>
                ...
                <ul class="nav flex-column pt-3 pt-md-0">
                    ...
                    <li class="nav-item">
                        <Link class="nav-link" to={{ pathname: "/addmember"}}>
                            <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <span class="nav-link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-app">
                            ...
                            <span class="sidebar-text">Active Members</span> 
                            </span>
                            <span class="link-arrow">
                            <svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20" xmlns="/addmember">
                        ...
                        <div class="multi-level collapse" role="list" id="submenu-app" aria-expanded="false">
                            ...
                            <li class="nav-item"><Link class="nav-link" to={{ pathname: "/activemembers"}}><span class="sidebar-text">Active Me</span></Link></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
